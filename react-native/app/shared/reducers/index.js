...
export const reducers = combineReducers({
  ...
  itemMasters: require('../../modules/entities/item-master/item-master.reducer').reducer,
  itemPackages: require('../../modules/entities/item-package/item-package.reducer').reducer,
  itemPackageDetails: require('../../modules/entities/item-package-details/item-package-details.reducer').reducer,
  pkgImages: require('../../modules/entities/pkg-images/pkg-images.reducer').reducer,
  userProducts: require('../../modules/entities/user-product/user-product.reducer').reducer,
